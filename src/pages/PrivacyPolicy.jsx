...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      />
      <div className="bg-black text-gray-200 p-8 max-w-4xl mx-auto mt-16 shadow-[0_0_15px_rgba(255,255,255,0.1)] rounded-lg">
        ...
        <ul className="list-disc pl-8 mb-4">
          ...
          <li className="mb-2">
            <p>
              ...
              in this Agreement) refers to calabriatechnology, 159 Wooster St,
          ...
          <li className="mb-2">
            <p>
              <strong>Website</strong> refers to calabriatechnology, accessible
              from
              <a
                href="https://www.calabriatechnology.com/"
                rel="external nofollow noopener noreferrer"
                target="_blank"
                className="text-blue-400 hover:underline ml-1"
              >
                https://www.calabriatechnology.com/
              </a>
            </p>
          </li>
          <li className="mb-2">
        ...
        <h4 className="text-lg font-bold mb-2 text-white">Law enforcement</h4>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-8 mb-4">
          <li className="mb-2">
            <p>By email: info@calabriatechnology.com</p>
          </li>
          <li className="mb-2">
            <p>
          ...
          <li className="mb-2">
            <p>By phone number: +16615912047</p>
          </li>
        </ul>
      </div>
    </>
